            ...
            self.downs.append(
                nn.ModuleList(
                    [
                        ...
                        Downsample(dim_in, dim_out) if not (ind >= (len(in_out) -1)) else nn.Conv2d(dim_in, dim_out, 3, padding=1),
                    ]
                )
            )
            ...
            self.ups.append(
                nn.ModuleList(
                    [
                        ...
                        Upsample(dim_out, dim_in) if not (ind >= (len(in_out) -1)) else nn.Conv2d(dim_out, dim_in, 3, padding=1),
                    ]
                )
            )
